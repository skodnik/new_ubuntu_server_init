...
# or wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/skodnik/new_ubuntu_server_init/master/server-init_ubuntu_2404.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.githubusercontent.com/skodnik/new_ubuntu_server_init/master/server-init_ubuntu_2404.sh
#   sh install.sh
...
# Install ncdu htop                                        #
############################################################
section_message "install ncdu htop"
apt install --yes ncdu htop
